                  ...
                  <table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_table_users">
                    ...
                    <tbody class="text-gray-600 fw-semibold">
                      ...
                      <tr>
                        ...
                        <td>
                          @if ($row->role == 1)
                            <div class="badge badge-danger fw-bold">Admin</div>
                          @else
                            <div class="badge badge-light-danger fw-bold">User</div>
                          @endif
                        </td>
                        ...
                        <td class="text-end">
                          ...
                          <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-semibold fs-7 w-125px py-4" data-kt-menu="true">
                            <div class="menu-item px-3">
                              <a href="#" data-bs-toggle="modal" data-bs-target="#kt_modal_add_user{{ $row->id }}" class="menu-link px-3">Change Role</a>
                            </div>
                            <div class="menu-item px-3">
                              <a class="menu-link px-3" onclick="confirmButtonText('user/delete/{{ $row->id }}')" data-kt-users-table-filter="delete_row">Delete</a>
                            </div>
                          </div>
                        </td>
                      </tr>
                        ...
                        <div class="modal-dialog modal-sm modal-dialog-centered">
                          <div class="modal-content">
                            <div class="modal-header" id="kt_modal_add_user_header">
                              <h2 class="fw-bold">Change Role</h2>
                              <div class="btn btn-icon btn-sm btn-active-icon-primary" data-bs-dismiss="modal" aria-label="Close">
                                <i class="ki-outline ki-cross fs-1"></i>
                              </div>
                            </div>
                            <div class="modal-body scroll-y ">
                              <form id="kt_modal_add_user_form" class="form" action="{{ route('user_update') }}" method="POST">
                                @csrf
                                ...
                                <div class="d-flex flex-column scroll-y " id="kt_modal_add_user_scroll" data-kt-scroll="true" data-kt-scroll-activate="{default: false, lg: true}" data-kt-scroll-max-height="auto" data-kt-scroll-dependencies="#kt_modal_add_user_header" data-kt-scroll-wrappers="#kt_modal_add_user_scroll" data-kt-scroll-offset="300px">
                                  <div class="fv-row mb-7">
                                    ...
                                    <select class="form-select form-select-solid fw-bold" name="role" data-kt-select2="true" data-placeholder="Select option" data-allow-clear="true" data-kt-user-table-filter="role" data-hide-search="true">
                                      @if ($row->role == 1)
