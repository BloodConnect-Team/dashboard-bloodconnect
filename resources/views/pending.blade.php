                    ...
                    <tbody class="text-gray-600 fw-semibold">
                      ...
                      <tr>
                        ...
                        <td class="text-end">
                          ...
                          <button type="button" onclick="confirmButtonApprove('/request/approve/{{ $row->id_requests }}')" class="btn btn-icon btn-light-danger btn-sm"><i class="ki-duotone ki-check fs-2"></i></button>
                          <a href="#" class="btn btn-light btn-active-light-primary btn-flex btn-center btn-sm" data-kt-menu-trigger="click" data-kt-menu-placement="bottom-end">Actions
                          <i class="ki-outline ki-down fs-5 ms-1"></i></a>
                          <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-semibold fs-7 w-125px py-4" data-kt-menu="true">
                            <div class="menu-item px-3">
                              <a class="menu-link px-3" onclick="confirmButtonText('/request/delete/{{ $row->id_requests }}')" data-kt-users-table-filter="delete_row">Delete</a>
                            </div>
                          </div>
                        </td>
                      </tr>
...
@section('script')
      ...
      <script>
        function confirmButtonApprove(link) {
          Swal.fire({
            text: "Are you sure approve this?",
            icon: "question",
            showCancelButton: !0,
            buttonsStyling: !1,
