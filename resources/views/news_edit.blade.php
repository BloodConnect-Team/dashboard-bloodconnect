              ...
              <div class="card mb-5 mb-xl-10">
                ...
                <div class="card-header pt-6">
                  ...
                  <div id="kt_account_settings_profile_details" class="collapse show">
                      <form action="{{ route('news_update') }}" method="POST" enctype="multipart/form-data" class="form fv-plugins-bootstrap5 fv-plugins-framework" novalidate="novalidate">
                        @csrf
                        <input type="hidden" name="id" value="{{$data['news']->id_news}}">
                          <div class="card-body border-top p-9">
                              <div class="row mb-6">
                                  ...
                                  <div class="col-lg-8">
                                      <div class="image-input image-input-outline" data-kt-image-input="true" style="background-image: url('{{ asset("assets/media/blank.svg") }}')">
                                          <div class="image-input-wrapper w-lg-500px h-lg-300px" style="background-image: url({{ $data['news']->image }})"></div>
                              ...
                              <div class="row mb-6">
                                  ...
                                  <div class="col-lg-8 fv-row fv-plugins-icon-container">
                                      <input type="text" name="title" class="form-control form-control-lg form-control-solid"  value="{{ $data['news']->title }}" placeholder="News Title" required>
                              ...
                              <div class="row mb-6">
                                ...
                                <div class="col-lg-8 fv-row fv-plugins-icon-container">
                                  <textarea name="content" class="bg-light form-control-solid"  id="kt_docs_ckeditor_classic" required>{{ $data['news']->content }}</textarea>
                                <div class="fv-plugins-message-container invalid-feedback"></div></div>
                            </div>
                          </div>
